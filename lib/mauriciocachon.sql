...
INSERT INTO `empleado` VALUES (1001153936,'Jhon','Kevin','Murillo','Martinez',1,1,1,'Cll 99 B',1,1,'3217153608','jhonkevinmurillom@gmail.com');
...
INSERT INTO `estadomascota` VALUES (1,'SANO'),(2,'ENFERMO'),(3,'FALLECIDO'),(4,'EXTRAVIADO');
...
CREATE TABLE `mascota` (
  ...
  `CedulaDoctor` int NOT NULL,
  `IDEstadoMasc` int NOT NULL,
  `FSalida` date NOT NULL,
  `IDTipoSalidaMasc` int NOT NULL,
...
INSERT INTO `propietario` VALUES (1001153936,'Jhon','Kevin','Murillo','Martinez',1,'05-08-2003','Cll 99B Casa',1,1,'3217153608','Jhonkevinmurillom@gmail.com'),(1234567890,'Jhon','Jhon','Jhon','Jhon',1,'10-05-2000','cll 99 ',1,1,'214151234','jhonjhon@gmail.com');
...
CREATE TABLE `usuario` (
  ...
  KEY `CedulaEmpleado` (`CedulaEmpleado`),
  KEY `Acceso` (`Acceso`),
  CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`CedulaEmpleado`) REFERENCES `empleado` (`CedulaEmpleado`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `usuario` VALUES (1,1001153936,'1234',1),(2,1001153937,'4321',3),(3,1001153938,'12tomas34',2);
...
-- Dump completed on 2024-05-19  0:25:21
