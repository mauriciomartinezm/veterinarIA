...
Future<Map<String, dynamic>> getCita(int IDCita) async {
  var url = Uri.parse(
      'http://https://veterinariaapi-2.onrender.com/getCita/$IDCita'); // Cambiado para emulador
...
Future<List<Map<String, dynamic>>> getCitas(String cedulaPropietario) async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/getCitas/$cedulaPropietario');
  var response =
...
Future<List<Map<String, dynamic>>> getHorarios() async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/getHorarios');
  var response =
      await http.get(url, headers: {'Content-Type': 'application/json'});
  if (response.statusCode == 200) {
    List<dynamic> responseBody = jsonDecode(response.body);
...
Future<Map<String, dynamic>> registerCita(
  ...
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/registerCita');
...
Future<Map<String, dynamic>> updateHorario(int IDHorario, String estado) async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/updateHorario/$IDHorario');
...
Future<void> deleteCita(int IDCita) async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/deleteCita/$IDCita');
