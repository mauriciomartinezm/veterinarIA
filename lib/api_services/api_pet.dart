...
Future<Pet> getPet(int IDMascota) async {
  var url = Uri.parse(
      'https://veterinariaapi-2.onrender.com/getPet/$IDMascota'); // Cambiado para emulador
...
Future<List<Map<String, dynamic>>> getPets(String cedulaPropietario) async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/getPets/$cedulaPropietario');
  var response =
...
Future<Map<String, dynamic>> registerPet(String nombre, String cedula) async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/registerPet');
...
Future<Map<String, dynamic>> updateInf(int IDMascota, String pet) async {
  print(pet);
  var url =
      Uri.parse('https://veterinariaapi-2.onrender.com/updatePet/$IDMascota'); // Cambiado para emulador
  try {
...
Future<void> deletePet(int IDMascota) async {
  var url = Uri.parse('https://veterinariaapi-2.onrender.com/deletePet/$IDMascota');
